            ...
            <header className="bg-white border-border border-1">
                <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between px-6 py-2 lg:px-8 py-4">
                    ...
                    <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-2">
                        <p className='font-bold' onClick={() => navigate("/host/explore")}>Cambiar a exploración</p>
                        <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600" onClick={() => navigate("/host/profile")}>
                                ...
                                <div
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button type="button" /*command="close" commandfor="mobile-menu" */ className="-m-2.5 rounded-md p-2.5 text-gray-400"
                                            ...
                                            <Menu fill="none" color="currentColor"
                                                aria-hidden="true"
                                                strokeWidth={1.5}
                                                className="size-6" />
                                        </button>
