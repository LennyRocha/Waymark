...
export default function AdminHeader() {
    ...
    useEffect(() => {
        ...
        console.log("pathname cambió:", location.pathname);
                ...
                <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                    <div className="flex flex-wrap justify-center md:justify-between items-center mx-auto max-w-screen-xl gap-2">
                        ...
                        <div className="flex items-center lg:order-2">
                            <button type="button" className="hidden md:flex text-sm bg-gray-800 rounded-full focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600" onClick={() => navigate("/admin/profile")}>
