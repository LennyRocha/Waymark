...
import { Dot, MapPinHouse, Menu } from 'lucide-react';
...
const Header = ({ toggle, value }) => {
  ...
  const showLink = useWatchResize({pixeles: 1125, metrica: "min"});
  const showBrand = useWatchResize({pixeles: 975, metrica: "min"});
